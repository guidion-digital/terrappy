...
You must ensure that the IAM policies for the application still work for the namespaced resources. For example, if you had policies allowing operations on `arn:aws:secretsmanager:eu-cetral-1:012345678901:secret:applications/foobar/*`, (where "foobar" was your application name) it will now have to be `arn:aws:secretsmanager:eu-cetral-1:012345678901:secret:applications/foobar*/*`.
